...
-- Snapshot Table
CREATE TABLE IF NOT EXISTS Snapshot (id INTEGER PRIMARY KEY AUTOINCREMENT, state BLOB NOT NULL, created_at TEXT NOT NULL, updated_at TEXT, sbom BLOB, error TEXT);
